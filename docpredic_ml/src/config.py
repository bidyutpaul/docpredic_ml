...
RAW_EXCEL_PATH = RAW_DATA_DIR / "SANIA@20.xlsx"
if not RAW_EXCEL_PATH.exists():
    RAW_EXCEL_PATH = PROJECT_ROOT.parent / "SANIA@20.xlsx"
if not RAW_EXCEL_PATH.exists():
    RAW_EXCEL_PATH = Path(r"C:\Users\Bidyut Paul\Downloads\DocPredic ML\SANIA@20.xlsx")
